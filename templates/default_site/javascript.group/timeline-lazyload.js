...
function Timeline(element, data, undefined) {
    ...
    this._default_element_data = {
		...
		milestone: 'milestone',     // blog_post   gallery    slider   iframe   video
		anchorhref: 'go-url_title', // blog_post   gallery    slider   iframe   video
    ...
    this._createElement = function(element_data, position) {
        ...
        // element DIV
        var element = $('<div>').addClass('timeline_element ' + element_data.type + ' milestone_toggle-'+ element_data.milestone).html('<a name="'+ element_data.anchorhref +'"></a>');
        ...
        var element_box = $('<div>').addClass('timeline_element_box' + ' milestone_toggle-'+ element_data.milestone).appendTo(element);
/*		var element_box = $('<div>').addClass('timeline_element_box' + ' milestone_toggle-'+ element_data.milestone).appendTo(element);*/
		

        // title DIV
        if (element_data.title !== null) {
            var title = $('<div>').addClass('timeline_title').html('<span class="milestone_flag"><i class="fa fa-bookmark"></i></span><span class="milestone_title"></span><span class="timeline_title_label">' + element_data.title + '</span><span class="timeline_title_date">' + SELF._getDateString(element_data.date, element_data.dateFormat) + '</span>').appendTo(element_box);
        } else {
...
// Entry Type blog post =========================================================================================================	
            case 'blog_post':
                ...
                if (element_data.image !== null) {
                    var img_container = $('<div>').addClass('img_container lazy')
                        .append($('<img>').attr('src', 'http://www.annikadalton.com/timeline/timeline_images/_timeline350/' + element_data.image))
                        //.append($('<img>').attr('data-src', 'http://www.annikadalton.com/timeline/timeline_images/_timeline350/' + element_data.image))
                        //.append($('<img>').attr('src', 'http://www.annikadalton.com/img/blank.gif'))
                        .appendTo(element_box);

                    if (SELF._options.lightbox) {
                        img_container.append($('<div>').addClass('img_overlay').html('<span class="magnifier" data-type="blog_post" data-img="http://www.annikadalton.com/timeline/timeline_images/_shadowbox/' + element_data.image + '"></span>'));
                    }
                }
            ...
            case 'gallery':
                ...
                if (element_data.images.length) {
                    ...
                    $(element_data.images).each(function(index, image_src) {
                        image_html += '<div class="img_container"><img height="' + element_data.height + '"  src="http://www.annikadalton.com/img/blank.gif" class="lazy" data-src="http://www.annikadalton.com/timeline/timeline_images/_timeline350/' + image_src + '" />';
                        if (SELF._options.lightbox) {
                            image_html += '<div class="img_overlay"><span class="magnifier" data-total="' + element_data.images.length + '" data-order="' + index + '" data-type="gallery" data-img="http://www.annikadalton.com/timeline/timeline_images/_shadowbox/' + image_src + '"></span></div>';
                        }
                        image_html += '</div>';
...
// Entry Type slider =========================================================================================================		
            case 'slider':
			   // slider
                var html = '';
                $(element_data.images).each(function(index, image_src) {
                    html += '<div data-total="' + element_data.images.length + '" data-order="' + index + '" class="img_container' + (index === 0 ? ' active' : '') + '" style="display:' + (index === 0 ? 'block' : 'none') + ';"><img src="http://www.annikadalton.com/img/blank.gif" class="lazy" data-src="http://www.annikadalton.com/timeline/timeline_images/_timeline350/' + image_src + '" />';
                    if (SELF._options.lightbox) {
                        html += '<div class="img_overlay"><span class="magnifier" data-total="' + element_data.images.length + '" data-order="' + index + '" data-type="slider" data-img="http://www.annikadalton.com/timeline/timeline_images/_shadowbox/' + image_src + '"></span></div>';
                    }
                    html += '</div>';
                });
...
// Entry Type video =========================================================================================================		
            case 'video':
                // html5 video
				if (element_data.url !== null) {
					
					
				//TEST STRING	
				/*var video_test = '<video controls  poster="http://www.annikadalton.com/timeline/timeline_videos/annika-11282014_First_Solid_Food.jpg" style="width:100%"><source src="http://www.annikadalton.com/timeline/timeline_videos/annika-11282014_First_Solid_Food.m4v" type="video/mp4" /><source src="http://www.annikadalton.com/timeline/timeline_videos/annika-11282014_First_Solid_Food.webm" type="video/webm" /><source src="http://www.annikadalton.com/timeline/timeline_videos/annika-11282014_First_Solid_Food.ogv" type="video/ogg" /></video>';*/
  
				//GET STRING FROM CMS  
				var video_html = element_data.url;
				
				
                    //var vid_container = $('<div>').addClass('html5video').html(video_test)
                    var vid_container = $('<div>').addClass('html5video').html(video_html)
...
// OVERLAY
//                    if (SELF._options.lightbox) {
//                        vid_container.append($('<div>').addClass('img_overlay').html('<span class="magnifier" data-type="blog_post" data-img="' + element_data.image + '"></span>'));
//                    }
        ...
        $.getJSON('http://api.melonhtml5.com/?action=twittersearch&q=' + SELF._options.twitterSearchKey + '&callback=?', function(response) {
            ...
            $(response.statuses).each(function(index, tweet_data) {
                ...
                twitter_data.push({
                    ...
                    content: '<div><img style="margin:0px 5px 5px 0px;" align="left" src="http://www.annikadalton.com/img/blank.gif" class="lazy" data-src="' + tweet_data.user.profile_image_url + '" /></div>' + tweet_data.text.parseURL().parseHashtag()
                });
            });
